...
/**
 * <p> A {@link InstantCommand} that go up 1 level from the shuffleboard at the tab angles </p>
 * @see RobotMap.ShuffleBoard#chooser5
 * @see OI#getAngle()
 */
public class SelectBoxUp extends InstantCommand {
   ...
   * <p>    * set the angle to the next value (the nearest higher than this) </p>
